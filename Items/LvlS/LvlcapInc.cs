...
{
    public class LvlcapInc : ModItem
    {
        ...
        {
            if (player.GetModPlayer<GGDPlayer>().lvlCap1 == false)
            {
                return true;
            }
            else
        ...
        public override bool UseItem(Player player)
        {
            ...
            player.GetModPlayer<GGDPlayer>().lvlCap1 = true;
            Main.NewText("You remove some of your limits", 139, 0 , 139);
            return true;
        }
